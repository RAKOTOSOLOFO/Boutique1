$(document).ready(function() {
   ...
   };    var index = GET_PARAM("index")    var main = $(".ficheproduit");
   ...
   var inputQuantite = $("<input id='quantite'></input>")    divRow.appendTo(main);
   ...
   inputQuantite.css("width", "4em");    var clickPlus = 0;    buttonPlus.click(function() {
